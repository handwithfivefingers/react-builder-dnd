  ...
  return (
    <div className="flex flex-col gap-2 items-center">
      <Select
        ...
        className="w-full"
      />
      {/* {value === "flex" && <FlexConfig {...flexOption} />} */}
    </div>
  );
};

Display.FlexDirection = FlexDirection;
Display.FlexConfig = FlexConfig;
Display.FlexJustify = FlexJustify;
Display.FlexGap = FlexGap;
export { Display };
